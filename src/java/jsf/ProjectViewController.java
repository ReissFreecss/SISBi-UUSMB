...
import jpa.session.ProjectFacadeSessionLocal;
import jpa.session.ProjectViewFacade;

@Named("projectViewController")
@SessionScoped
public class ProjectViewController implements Serializable {

    private ProjectView current;
    private DataModel items = null;
    @EJB
    private jpa.session.ProjectViewFacade ejbFacade;
    ...
    public ProjectView getSelected() {
        if (current == null) {
            current = new ProjectView();
            selectedItemIndex = -1;
        }
        return current;
    }

    private ProjectViewFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (ProjectView) getItems().getRowData();
    ...
    public String create(ActionEvent event) {
        try {
            ...
            current.setIdProject("Project_"+us.getUserName()+"_"+tiempo[0]+":"+tiempo[1]+":"+tiempo[2]);
    ...
    public ProjectView getProject(java.lang.String id) {
    ...
    public static class ProjectControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            ProjectViewController controller = (ProjectViewController) facesContext.getApplication().getELResolver().
